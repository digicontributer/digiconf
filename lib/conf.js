...
function generate(opts, cb) {
    const node = [
        '# This config was generated by DigiConf https://conf.digibyte.io\n',
        '\n',
...
/*
* Loads rpcuser.py to generate rpcauth
* @username {string} the username to generate auth for
* @returns {object}
*/
function getRpcDetails(username, cb) {
    cmd.get(`python ./lib/rpcuser.py ${username}`, (err, data, stderr) => {
        if (err) {
            return cb(err);
        }
        var commands = null;
